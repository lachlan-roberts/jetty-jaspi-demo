...
public class TestServerAuthModule implements ServerAuthModule
{
    ...
    public AuthStatus validateRequest(MessageInfo messageInfo, Subject clientSubject, Subject serviceSubject) throws AuthException
    {
        ...
        // TODO: this works with a principal class but not with string name.
        CustomPrincipal principal = new CustomPrincipal("testUserPrincipal");
        CallerPrincipalCallback callerPrincipalCallback = new CallerPrincipalCallback(clientSubject, principal);

        // Create a handler to add the group (AKA role) "architect"
        // This is what e.g. HttpServletRequest#isUserInRole and @RolesAllowed
        // test for
        GroupPrincipalCallback groupPrincipalCallback = new GroupPrincipalCallback(clientSubject, new String[]{"admin"});
