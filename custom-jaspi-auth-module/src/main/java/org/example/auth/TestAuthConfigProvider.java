...
public class TestAuthConfigProvider implements AuthConfigProvider
{
    ...
    public TestAuthConfigProvider(Map<String, String> properties, AuthConfigFactory factory)
    {
        ...
        // API requires self registration if factory is provided. Not clear where the "layer" (2nd parameter) and
        // especially "appContext" (3rd parameter) values have to come from at this place.
        if (factory != null)
    ...
    /**
     * Creates a default callback handler via the system property "authconfigprovider.client.callbackhandler",
     * as seemingly required by the API (API uses wording "may" create default handler).
     */
